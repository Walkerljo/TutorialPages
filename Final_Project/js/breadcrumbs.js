...
BagOCrumbs[0] = new Crumb("../", "Home", "index.html/");
BagOCrumbs[1] = new Crumb("../", "Topics", "topics.html");
BagOCrumbs[2] = new Crumb("../", "Computer Science", "compSci.html");
BagOCrumbs[3] = new Crumb("../", "Graphic Design", "design.html");
BagOCrumbs[4] = new Crumb("../", "7th Grade Math", "7thMath.html");
BagOCrumbs[5] = new Crumb("../", "Ratios and Proportions", "rato1.html");
BagOCrumbs[6] = new Crumb("../", "Constant of Proportionality", "CoP1.html");
